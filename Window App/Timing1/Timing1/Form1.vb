...
Public Class Form1
    ...
    Private Sub timer_Tick(ByVal sender As Object, ByVal e As EventArgs) Handles Timer.Tick
        ' Make the form element visible after 3 seconds
        loadMain()
    ...
    Sub loadMain()
        ...
        'Me.BackgroundImage = Image.FromFile("C:\Users\ADMIN\OneDrive\Documents\Visual Studio 2010\Projects\Window App\Timing1\Timing1\background.jpeg")
    ...
    Private Sub Closebtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Buttonclose.Click
        Me.Close()
    End Sub
